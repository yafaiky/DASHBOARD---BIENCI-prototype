        ...
        <div className="relative max-w-md w-full hidden sm:block">
          ...
          >
            <div className="flex items-center gap-2.5">
              ...
              <span>Cari karyawan, NIK, departemen...</span>
            </div>
            ...
            <div className="absolute right-0 mt-2 w-80 sm:w-96 bg-white rounded-xl shadow-xl border border-slate-200 py-2 z-50 animate-in fade-in zoom-in-95 duration-100">
              ...
              <div className="divide-y divide-slate-100 max-h-72 overflow-y-auto">
                <div className="p-3.5 hover:bg-slate-50 transition-colors cursor-pointer flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[11px] text-slate-500 mt-0.5">
                      Staf retail Jawa Barat & Jabodetabek
                    </p>
                ...
                <div className="p-3.5 hover:bg-slate-50 transition-colors cursor-pointer flex gap-3">
                  ...
                  <div>
                    <p className="text-xs font-semibold text-slate-900">
                      Biaya tenaga kerja Komersil melebihi anggaran
                    </p>
                    <p className="text-[11px] text-slate-500 mt-0.5">
                      +4.2% di atas batas kuota Q3
                    </p>
                    <span className="text-[10px] text-slate-400 mt-1 block">
                      1 jam lalu
                    </span>
                ...
                <div className="p-3.5 hover:bg-slate-50 transition-colors cursor-pointer flex gap-3">
                  ...
                  <div>
                    <p className="text-xs font-semibold text-slate-900">
                      Impor massal 124 data berhasil
                    </p>
                    <p className="text-[11px] text-slate-500 mt-0.5">
                      store_recruitment.xlsx diproses tanpa error
                    </p>
                    <span className="text-[10px] text-slate-400 mt-1 block">
                      3 jam lalu
                    </span>
            ...
            <div className="absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-xl border border-slate-200 py-1.5 z-50 animate-in fade-in duration-100">
              <div className="px-4 py-2.5 border-b border-slate-100">
                ...
                <span className="inline-flex items-center gap-1 mt-1 px-1.5 py-0.5 text-[10px] font-semibold text-emerald-700 bg-emerald-50 rounded">
                  <CheckCircle2 className="w-3 h-3" /> Terhubung Live Engine
                </span>
              </div>
              <div className="py-1">
                <Link
                ...
                >
                  <User className="w-4 h-4 text-slate-400" /> Detail Profil
                </Link>
                <Link
                  to="/settings"
                  onClick={() => setShowProfileMenu(false)}
                  className="flex items-center gap-2.5 px-4 py-2 text-xs text-slate-700 hover:bg-slate-50"
                >
                  <SettingsIcon className="w-4 h-4 text-slate-400" /> Pengaturan Sistem
                </Link>
              </div>
